...
// Full set of reaction options — available wherever people are actively
// reacting (the post detail page). The compact feed card only surfaces
// the first two (like/dislike) for a fast, uncluttered glance.
export const REACTION_EMOJIS = ['❤️', '👎', '😂', '👏', '😮']

export function getLikes(post: CirclePost) {
  return post.reactions['❤️'] ?? 0
}

export function getDislikes(post: CirclePost) {
